Adopt Open JRE x64 8.0.100 ML (Multi-Language)
...
msiexec /i "AdoptOpenJDK_JRE_Hotspot_64_8.0.100.0_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "AdoptOpenJDK_JRE_Hotspot_64_8.0.100.0_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
