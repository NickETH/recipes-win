Adopt Open JRE x86 8.0.100 ML (Multi-Language)
...
Slient Install: msiexec /i "AdoptOpenJDK_JRE_Hotspot_8.0.100.0_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
